...
fun Tag.divContainer(vararg kv: TagAttr, block: TagBlock): Tag {
	return this.div("class" to "container", *kv, block = block)
}

fun Tag.divContainerFluid(vararg kv: TagAttr, block: TagBlock): Tag {
	return this.div("class" to "container-fluid", *kv, block = block)
}

fun Tag.divRow(vararg kv: TagAttr, block: TagBlock): Tag {
	return this.div("class" to "row", * kv, block = block)
}

fun Tag.divCol(vararg kv: TagAttr, block: TagBlock): Tag {
	return this.div("class" to "col", * kv, block = block)
}


fun Tag.divCol1(vararg kv: TagAttr, block: TagBlock): Tag {
	return this.div("class" to "col-1", *kv, block = block)
}

fun Tag.divCol2(vararg kv: TagAttr, block: TagBlock): Tag {
	return this.div("class" to "col-2", *kv, block = block)
}

fun Tag.divCol3(vararg kv: TagAttr, block: TagBlock): Tag {
	return this.div("class" to "col-3", *kv, block = block)
}

fun Tag.divCol4(vararg kv: TagAttr, block: TagBlock): Tag {
	return this.div("class" to "col-4", *kv, block = block)
}

fun Tag.divCol5(vararg kv: TagAttr, block: TagBlock): Tag {
	return this.div("class" to "col-5", *kv, block = block)
}

fun Tag.divCol6(vararg kv: TagAttr, block: TagBlock): Tag {
	return this.div("class" to "col-6", *kv, block = block)
}

fun Tag.divCol7(vararg kv: TagAttr, block: TagBlock): Tag {
	return this.div("class" to "col-7", *kv, block = block)
}

fun Tag.divCol8(vararg kv: TagAttr, block: TagBlock): Tag {
	return this.div("class" to "col-8", *kv, block = block)
}

fun Tag.divCol9(vararg kv: TagAttr, block: TagBlock): Tag {
	return this.div("class" to "col-9", *kv, block = block)
}

fun Tag.divCol10(vararg kv: TagAttr, block: TagBlock): Tag {
	return this.div("class" to "col-10", *kv, block = block)
}

fun Tag.divCol11(vararg kv: TagAttr, block: TagBlock): Tag {
	return this.div("class" to "col-11", *kv, block = block)
}

fun Tag.divCol12(vararg kv: TagAttr, block: TagBlock): Tag {
	return this.div("class" to "col-12", *kv, block = block)
}


fun Tag.row(vararg kv: TagAttr, block: TagBlock): Tag {
	return this.div("class" to "row", * kv, block = block)
}

fun Tag.rowCenter(vararg kv: TagAttr, block: TagBlock): Tag {
	return this.div("class" to "row".."justify-content-center", * kv, block = block)
}

fun Tag.colX(vararg kv: TagAttr, block: TagBlock): Tag {
	return this.div("class" to _colx, *kv, block = block)
}

fun Tag.colXN(n: Int, vararg kv: TagAttr, block: TagBlock): Tag {
	assert(n in 1..12)
	return this.div("class" to "col-12".."col-md-$n", *kv, block = block)
}

fun Tag.colX1(vararg kv: TagAttr, block: TagBlock): Tag {
	return this.div("class" to _colx_1, *kv, block = block)
}

fun Tag.colX2(vararg kv: TagAttr, block: TagBlock): Tag {
	return this.div("class" to _colx_2, *kv, block = block)
}

fun Tag.colX3(vararg kv: TagAttr, block: TagBlock): Tag {
	return this.div("class" to _colx_3, *kv, block = block)
}

fun Tag.colX4(vararg kv: TagAttr, block: TagBlock): Tag {
	return this.div("class" to _colx_4, *kv, block = block)
}

fun Tag.colX5(vararg kv: TagAttr, block: TagBlock): Tag {
	return this.div("class" to _colx_5, *kv, block = block)
}

fun Tag.colX6(vararg kv: TagAttr, block: TagBlock): Tag {
	return this.div("class" to _colx_6, *kv, block = block)
}


fun Tag.colX7(vararg kv: TagAttr, block: TagBlock): Tag {
	return this.div("class" to _colx_7, *kv, block = block)
}

fun Tag.colX8(vararg kv: TagAttr, block: TagBlock): Tag {
	return this.div("class" to _colx_8, *kv, block = block)
}

fun Tag.colX9(vararg kv: TagAttr, block: TagBlock): Tag {
	return this.div("class" to _colx_9, *kv, block = block)
}

fun Tag.colX10(vararg kv: TagAttr, block: TagBlock): Tag {
	return this.div("class" to _colx_10, *kv, block = block)
}

fun Tag.colX11(vararg kv: TagAttr, block: TagBlock): Tag {
	return this.div("class" to _colx_11, *kv, block = block)
}

fun Tag.colX12(vararg kv: TagAttr, block: TagBlock): Tag {
